...
CREATE TABLE system_settings (
    ...
    hide_limits_in_user_list BOOLEAN NOT NULL DEFAULT false,
    add_new_nas_to_all_services BOOLEAN NOT NULL DEFAULT true,
    add_new_manager_to_all_services BOOLEAN NOT NULL DEFAULT false,
    disconnect_time_hour SMALLINT NOT NULL DEFAULT 23,
    disconnect_time_minute SMALLINT NOT NULL DEFAULT 59,
    -- Billing
    currency VARCHAR(10) NOT NULL DEFAULT 'USD',
    vat_percent DECIMAL(5,2) NOT NULL DEFAULT 0,
    adv_sales_tax DECIMAL(5,2) NOT NULL DEFAULT 0,
    postpaid_renewal_day SMALLINT NOT NULL DEFAULT 1,
    billing_period_start SMALLINT NOT NULL DEFAULT 1,
    grace_period_days SMALLINT NOT NULL DEFAULT 1,
    reset_credits_on_service_change BOOLEAN NOT NULL DEFAULT true,
    disconnect_postpaid_at_billing_start BOOLEAN NOT NULL DEFAULT false,
    disable_accounts_unpaid_invoices BOOLEAN NOT NULL DEFAULT true,
    disable_accounts_expired_contract BOOLEAN NOT NULL DEFAULT true,
    enable_voucher_redemption BOOLEAN NOT NULL DEFAULT true,
    enable_account_recharge BOOLEAN NOT NULL DEFAULT true,
    enable_deposit_purchase BOOLEAN NOT NULL DEFAULT true,
    gw_internal BOOLEAN NOT NULL DEFAULT true,
    gw_paypal_standard BOOLEAN NOT NULL DEFAULT false,
    gw_paypal_pro BOOLEAN NOT NULL DEFAULT false,
    gw_paypal_express BOOLEAN NOT NULL DEFAULT false,
    gw_netcash BOOLEAN NOT NULL DEFAULT false,
    gw_payfast BOOLEAN NOT NULL DEFAULT false,
    gw_authorize_net BOOLEAN NOT NULL DEFAULT false,
    gw_dps_payment_express BOOLEAN NOT NULL DEFAULT false,
    gw_2checkout BOOLEAN NOT NULL DEFAULT false,
    gw_payu BOOLEAN NOT NULL DEFAULT false,
    gw_paytm BOOLEAN NOT NULL DEFAULT false,
    gw_bkash BOOLEAN NOT NULL DEFAULT false,
    gw_flutterwave BOOLEAN NOT NULL DEFAULT false,
    gw_easypay BOOLEAN NOT NULL DEFAULT false,
    gw_mpesa BOOLEAN NOT NULL DEFAULT false,
    gw_custom BOOLEAN NOT NULL DEFAULT false,
    -- Account
    lock_first_mac BOOLEAN NOT NULL DEFAULT false,
    ucp_edit_data BOOLEAN NOT NULL DEFAULT false,
    ucp_service_change VARCHAR(20) NOT NULL DEFAULT 'never',
    ucp_change_password BOOLEAN NOT NULL DEFAULT false,
    ...
    self_reg_name_requires_sms BOOLEAN NOT NULL DEFAULT false,
    self_reg_name_requires_email BOOLEAN NOT NULL DEFAULT false,
    self_reg_cell_requires_sms BOOLEAN NOT NULL DEFAULT false,
    self_reg_mandatory_fields JSONB DEFAULT '[]',
    self_reg_allow_duplicate_email BOOLEAN NOT NULL DEFAULT false,
    self_reg_allow_duplicate_cell BOOLEAN NOT NULL DEFAULT false,
    self_reg_default_sim_use SMALLINT NOT NULL DEFAULT 1,
    self_reg_default_user_group VARCHAR(100),
    captcha_enabled BOOLEAN NOT NULL DEFAULT false,
    ias_mandatory_fields JSONB DEFAULT '[]',
    ias_allow_duplicate_email BOOLEAN NOT NULL DEFAULT false,
    ias_allow_duplicate_cell BOOLEAN NOT NULL DEFAULT false,
    ias_sms_verification BOOLEAN NOT NULL DEFAULT false,
    -- Notifications
    notify_manager_on_reg_email BOOLEAN NOT NULL DEFAULT true,
    new_service_plan_email BOOLEAN NOT NULL DEFAULT true,
    new_service_plan_sms BOOLEAN NOT NULL DEFAULT false,
    welcome_email BOOLEAN NOT NULL DEFAULT true,
    welcome_sms BOOLEAN NOT NULL DEFAULT false,
    renewal_notification_email BOOLEAN NOT NULL DEFAULT true,
    renewal_notification_sms BOOLEAN NOT NULL DEFAULT false,
    expiry_alert_email BOOLEAN NOT NULL DEFAULT true,
    expiry_alert_sms BOOLEAN NOT NULL DEFAULT true,
    alert_level_type VARCHAR(20) NOT NULL DEFAULT 'percent',
    alert_dl_mb DECIMAL(10,2) NOT NULL DEFAULT 0,
    alert_dl_percent DECIMAL(5,2) NOT NULL DEFAULT 0,
    alert_ul_mb DECIMAL(10,2) NOT NULL DEFAULT 0,
    alert_ul_percent DECIMAL(5,2) NOT NULL DEFAULT 0,
    alert_total_mb DECIMAL(10,2) NOT NULL DEFAULT 0,
    alert_total_percent DECIMAL(5,2) NOT NULL DEFAULT 0,
    alert_online_time VARCHAR(10) NOT NULL DEFAULT '00:00:00',
    alert_online_time_percent DECIMAL(5,2) NOT NULL DEFAULT 0,
